  ...
  **/
  async getBalance (mainnet) {
    try {
      ...
      if (typeof (balance) === 'undefined' || balance === null || !balance.hasOwnProperty('confirmedBalance') ||
      !balance.hasOwnProperty('unConfirmedBalance')) {
      ...
      logger.info(`BALANCE of ${this.username} received.`)
      return this.balance
    } catch (error) {
      console.error(error)
      return null
