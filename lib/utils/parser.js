      ...
      switch (command) {
        ...
        default:
          ...
          if (arkToshiValue !== null) {
            ...
            return {command: 'TIP', arkToshiValue: arkToshiValue.arkToshiValue}
          }
      }
    } catch (error) {
      logger.warn(error)
      ...
      switch (command) {
        case 'SEND': // SEND [<username> <amount> [currency]]
          if (await receiver.isValidUser()) {
            ...
            if (arkToshiValue !== null && arkToshiValue.arkToshiValue !== null) {
              return {command, arkToshiValue: arkToshiValue.arkToshiValue, username: arg1.replace('u/', '')}
            }
          }
          return {command}
        ...
        case 'DONATE': // DONATE [<amount> [currency]]
          ...
          if (arkToshiValue !== null && arkToshiValue.arkToshiValue !== null) {
            ...
            return {command, arkToshiValue: arkToshiValue.arkToshiValue, username}
          }
          return {command}
        case 'WITHDRAW': // WITHDRAW [<address> <amount> [currency]]
          ...
          if (arkToshiValue !== null && arkToshiValue.arkToshiValue !== null) {
            if (this.validateInput(arkToshiValue.arkToshiValue, arg1)) {
              return {command, arkToshiValue: arkToshiValue.arkToshiValue, address: arg1}
            }
          }
