...
logger.warn(`TX: ${recepient}, ${amount}, ${smartBridge}, ${passphrase}, ${secondSecret}`)
      const transaction = this.transactionBuilder.createTransaction(amount, recepient, smartBridge, passphrase, secondSecret)
