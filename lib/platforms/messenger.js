...
class Messenger {
  ...
  async sendHelpMessage (to, helpSubject) {
    try {
      ...
      switch (helpSubject) {
        case 'TIP':
          message = messages.sendTipHelpReply()
          break
        case 'WITHDRAW':
          message = messages.helpWithdrawMessage()
          break
        case 'SEND':
          message = messages.helpSendMessage()
          break
        case 'STICKERS':
          message = messages.helpStickersMessage()
          break       
      }
      const text = message + messages.smallFooter()
